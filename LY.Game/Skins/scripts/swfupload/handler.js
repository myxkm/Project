...
function initPage()
{
    ...
    $("#upFile .lt").css("display","");
    $("#upFile #count").css("display","");
    //alert();
    //fileList.button('11'); 
...
{
	//console.log("uploadStart:"+JSON.stringify(file));
...
function uploadProgress(file, bytesLoaded) {
	//console.log("uploadProgress:"+JSON.stringify(file));
	...
	try {  	
		...
		this.debug(ex);
		//console.log("uploadProgress_Error:"+ex.message);
	}
}
...
function uploadSuccess(file, serverData) {
	...
	//console.log("uploadSuccess:"+serverData);
    var fileobj = JSON.parse(serverData);
    try {
        if (fileobj.state != "success")//不成功 		 
        {
