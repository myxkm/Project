function table(obj){
	...
	this.button=function(x){//按钮状态
		...
		if(x=="00"){
			...
			delList.className=Upload.className=obj.buttonClassName.initial;
		}
		else if(x=="11"){
			...
			this.cc(delList,{"className":""+obj.buttonClassName.initial+"","onclick":"this.blur();"});
			this.cc(Upload,{"className":""+obj.buttonClassName.initial+"","innerHTML":"停止上传","onclick":"eval('"+obj.stopFileUpLoad+"');this.blur();"});
		}
		else if(x=="10"){
			this.cc(delList,{"className":""+obj.buttonClassName.initial+"","onclick":"my.allRemove();this.blur();"});
			this.cc(Upload,{"className":""+obj.buttonClassName.initial+"","innerHTML":"开始上传","onclick":"this.blur();"});
		}
	}
