...
namespace LY.Framework.Comman
{
    ...
    public class GetSystemInfo
    {
        ...
        private static RegistryKey folders = OpenRegistryPath(Registry.LocalMachine, @"/software/microsoft/windows/currentversion/explorer/shell folders");

        /// <summary>
        /// 获取公用桌面路径  
        /// </summary>
        public static string GetAllUsersDesktopFolderPath = folders.GetValue("Common Desktop").ToString();
        /// <summary>
        /// 获取公用启动项路径
        /// </summary>
        public static string GetAllUsersStartupFolderPath = folders.GetValue("Common Startup").ToString();
        /// <summary>
        ///  Windows用户桌面路径
        /// </summary>
        private static string desktopPath = folders.GetValue("Common Desktop").ToString();

        /// <summary>
        /// Windows用户字体目录路径
        /// </summary>
        public static string fontsPath = folders.GetValue("Fonts").ToString();
        /// <summary>
        /// // Windows用户网络邻居路径
        /// </summary>
        public static string nethoodPath = folders.GetValue("Nethood").ToString();
        /// <summary>
        /// // Windows用户我的文档路径
        /// </summary>
        public static string personalPath = folders.GetValue("Personal").ToString();
        /// <summary>
        /// // Windows用户开始菜单程序路径
        /// </summary>
        public static string programsPath = folders.GetValue("Programs").ToString();
        /// <summary>
        /// // Windows用户存放用户最近访问文档快捷方式的目录路径
        /// </summary>
        public static string recentPath = folders.GetValue("Recent").ToString();
        /// <summary>
        /// // Windows用户发送到目录路径
        /// </summary>
        public static string sendtoPath = folders.GetValue("Sendto").ToString();
        /// <summary>
        /// // Windows用户开始菜单目录路径
        /// </summary>
        public static string startmenuPath = folders.GetValue("Startmenu").ToString();
        /// <summary>
        /// // Windows用户开始菜单启动项目录路径
        /// </summary>
        public static string startupPath = folders.GetValue("Startup").ToString();
        /// <summary>
        /// // Windows用户收藏夹目录路径
        /// </summary>
        public static string favoritesPath = folders.GetValue("Favorites").ToString();
        /// <summary>
        /// // Windows用户网页历史目录路径
        /// </summary>
        public static string historyPath = folders.GetValue("History").ToString();
        /// <summary>
        /// // Windows用户Cookies目录路径
        /// </summary>
        public static string cookiesPath = folders.GetValue("Cookies").ToString();
        /// <summary>
        ///  // Windows用户Cache目录路径
        /// </summary>
        public static string cachePath = folders.GetValue("Cache").ToString();
        /// <summary>
        ///  Windows用户应用程式数据目录路径
        /// </summary>
        public static string appdataPath = folders.GetValue("Appdata").ToString();
        /// <summary>
        ///  // Windows用户打印目录路径
        /// </summary>
        public static string printhoodPath = folders.GetValue("Printhood").ToString();
