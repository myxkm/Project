...
namespace Ruanmou.LuceneProject.Service
{
    ...
    {
        #region Identity
        private LoggerHelper logger = new LoggerHelper(typeof(LuceneQuery));
        #endregion Identity
        ...
        /// <returns></returns>
        public List<T> QueryIndex<T>(string queryString)
        {
        ...
        /// <returns></returns>
        public List<T> QueryIndexPage<T>(string queryString, int pageIndex, int pageSize, out int totalCount, string priceFilter, string priceOrderBy)
        {
            totalCount = 0;
            IndexSearcher searcher = null;
            try
        ...
        #region private
        private T DocumentToCommodityInfo<T>(Document doc)
        {
            return default(T);
            //return new T()
            //           {
