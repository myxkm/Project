...
namespace LY.Framework.Lucene.Interface
{
    public interface ILuceneBulid
    {
        ...
        void BuildIndex<T>(List<T> ciList, string pathSuffix = "", bool isCreate = false);
        ...
        /// </summary>
        /// <param name="ci"></param>
        void InsertIndex<T>(T ci);

        /// <summary>
        /// 批量新增数据的索引
        /// </summary>
        /// <param name="ciList">sourceflag统一的</param>
        void InsertIndexMuti<T>(List<T> ciList);

        /// <summary>
        /// 删除一条数据的索引
        /// </summary>
        /// <param name="ci"></param>
        void DeleteIndex<T>(T ci);

         /// <summary>
        /// 批量删除数据的索引
        /// </summary>
        /// <param name="ciList">sourceflag统一的</param>
        void DeleteIndexMuti<T>(List<T> ciList);

        /// <summary>
        /// 更新一条数据的索引
        /// </summary>
        /// <param name="ci"></param>
        void UpdateIndex<T>(T ci);

        /// <summary>
        /// 批量更新数据的索引
        /// </summary>
        /// <param name="ciList">sourceflag统一的</param>
        void UpdateIndexMuti<T>(List<T> ciList);
    }
}
